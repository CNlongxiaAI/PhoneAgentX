...
/**
 * Bridge Server 管理器
 * HTTP (:18790) → Socket (:28200) → TutuGui Server
 */
class BridgeServerManager(
    ...
    fun start() {
        ...
        Thread {
            try {
                ...
                Log.i(TAG, "Bridge Server 启动于端口 $PORT")
    ...
    private fun getScreenSize(): Pair<Int, Int> = Pair(1080, 1920) // TODO: 从设备获取
}