...
<p align="center">
  <img src="docs/assets/logo_banner.png" alt="AgentClaw" width="560" onerror="this.style.display='none'" />
</p>

<p align="center">
  <strong>让 OpenClaw AI 在手机上真正长出手和脚</strong>
</p>
...
<p align="center">
  ...
  &nbsp;·&nbsp;
  <a href="docs/node-host-guide.md">Node Host 开发</a>
  &nbsp;·&nbsp;
  <a href="docs/skill-dev-guide.md">Skill 开发</a>
  &nbsp;·&nbsp;
...
<p align="center">
  ...
  <a href="https://github.com/longxiashouji/AgentClaw/stargazers">
    <img src="https://img.shields.io/github/stars/longxiashouji/AgentClaw?style=social" alt="Stars" />
  </a>
  <a href="https://github.com/longxiashouji/AgentClaw/network/members">
    <img src="https://img.shields.io/github/forks/longxiashouji/AgentClaw?style=social" alt="Forks" />
  </a>
  <a href="https://github.com/longxiashouji/AgentClaw/issues">
    <img src="https://img.shields.io/github/issues/longxiashouji/AgentClaw" alt="Issues" />
  </a>
</p>
...
**AgentClaw** 是 OpenClaw 的手机端节点运行时。它让 AI 能够像真人一样操作你的手机：
...
> 你对 AI 说"帮我打开微信，给朋友发消息：明天吃饭"，AgentClaw 让 AI 真正做到。
...
大多数手机自动化工具（Auto.js、Hamibot 等）用 **无障碍服务（AccessibilityService）**，但这有三个致命问题：
...
用 JSON 定义，包含多个步骤，AgentClaw 自动执行。
...
| 模块 | 文件 | 作用 |
|------|------|------|
| **Node Host** | `agentclaw-node-host.js` | 连接 Gateway，接收 AI 命令 |
...
AgentClaw/
│
├── agentclaw-node-host.js        # 🌟 Node Host 主程序
│                                 #    连接 Gateway，转发命令到手机
│
├── agentclaw-app/                # 📱 Android App 源码
│   └── src/main/java/com/agentclaw/
│       ├── AgentClawApp.kt       #    Application 入口
│       ├── MainActivity.kt       #    主界面
│       │
│       ├── core/                 #    核心模块
...
### Q: AgentClaw 和 MeowHub 有什么关系？
A: 没有关系。AgentClaw 是完全独立开发的开源项目，使用不同的架构设计。
...
AgentClaw 的实现参考了以下优秀开源项目：

- **[scrcpy](https://github.com/Genymobile/scrcpy)** — 优秀的屏幕投射工具，其设计启发了 AgentClaw 的设备控制层
